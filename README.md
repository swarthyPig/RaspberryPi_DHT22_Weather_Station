...
### 전체적인 흐름
  ...
  * mongoDB folder
    ...
    - mongoDB에 저장한 데이터를 export하여 생성된 csv파일을 사용하여 파이썬 라이브러리를 통해서 데이터를 분석하고 mining하였습니다.
    
  * data mining folder
    - mongoDB로 축적한 데이터를 export하여 만들어진 csv파일로 Google Colab과 Python을 사용하여 데이터 마이닝을 하였습니다.
